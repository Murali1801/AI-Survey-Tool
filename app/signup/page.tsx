      ...
      <main className="flex min-h-[calc(100vh-4rem)] items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center space-y-2">
            <h1 className="font-work-sans text-3xl font-bold text-foreground">Create your account</h1>
            <p className="text-muted-foreground">Start building smarter surveys today</p>
          </div>
          <SignupForm />
